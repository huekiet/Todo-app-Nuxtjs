<template>
  <div class="container">
    <div class="col-sm-9">
      ...
      <div class="label priority high">
        <span>High priority</span>
      </div>
      <div class="list-todo priority high">
          <div v-for="todo in highPriorityTodos" :key="todo.id" class="todo-item">
            <div class="todo-name">{{ todo.name }}</div>
            <div class="todo-description">{{ todo.description }}</div>
          </div>
      </div>

      <div class="label priority medium">
...
.list-todo.priority.high .todo-item {
