<template>
  <div class="container">
    <div class="col-sm-9 mx-auto main-content">
      ...
      <ul>
        <li v-for="todo in filterTodosHighPriority" :key="todo.id">
      ...
      <ul>
        <li v-for="todo in filterTodosMediumPriority" :key="todo.id">
          <div class="todo-name">{{ todo.name }}</div>
          <div class="todo-description">{{ todo.description }}</div>
        </li>
      </ul>
      ...
      <ul>
        <li v-for="todo in filterTodosLowPriority" :key="todo.id">
          <div class="todo-name">{{ todo.name }}</div>
          <div class="todo-description">{{ todo.description }}</div>
        </li>
      </ul>
...
export default {
  ...
  computed: {
    ...
    highPriorityTodos() {
      return this.$store.getters[`todo/getHighPriority`];
    },

    mediumPriorityTodos() {
      return this.$store.getters[`todo/getMediumPriority`];
    },

    lowPriorityTodo() {
      return this.$store.getters[`todo/getLowPriority`];
    },
