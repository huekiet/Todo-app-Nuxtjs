<template>
  <div class="main-content">
    ...
    <div class="filter-button-group">
      <button @click.self="clickDone()" class="btn btn-sm btn-outline-warning">Done({{ countDoneTodos }})</button>
      <button @click.self="clickIncompleted()" class="btn btn-sm btn-outline-danger">Incompleted({{ countIncompletedTodos }})</button>
      <button @click.self="clickAll()" class="btn btn-sm btn-outline-info">All({{ countTotalTodos }})</button>
    </div>
